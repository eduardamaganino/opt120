...
class _LoginPageState extends State<LoginPage> {
  ...
  bool _obscureText = true; // Estado para controlar se a senha está obscurecida

  // Função para alternar entre a visualização da senha obscurecida e não obscurecida
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(
            255, 236, 127, 165), // Change the color to your desired color

        leading: const Icon(
          Icons.login, // Change the icon to your desired icon
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextField(
              ...
              obscureText:
                  _obscureText, // Use o estado para obscurecer ou não a senha
              decoration: InputDecoration(
                ...
                suffixIcon: GestureDetector(
                  onTap:
                      _togglePasswordVisibility, // Alternar visibilidade da senha ao tocar no ícone
                  child: Icon(
